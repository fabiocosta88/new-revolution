...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -80, maxDamage = -400, condition = {type = CONDITION_POISON, totalDamage = 600, interval = 4000}},
	{name ="silencer skill reducer", interval = 2000, chance = 5, range = 3, target = false},
...
monster.defenses = {
	...
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_HEALING, minDamage = 100, maxDamage = 180, effect = CONST_ME_MAGIC_BLUE, target = false}
}
