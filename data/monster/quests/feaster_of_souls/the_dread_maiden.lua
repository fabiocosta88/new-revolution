...
monster.description = "a dread maiden"
...
monster.loot = {
	...
	{name = "jagged sickle", chance = 5880},
	{id = 32596, chance = 5880},
	{name = "amber", chance = 5880},
	{name = "amber with a dragonfly", chance = 3920},
	{name = "ghost claw", chance = 1960},
	{name = "pair of nightmare boots", chance = 550},
	{name = "spooky hood", chance = 1960}
}

monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -250, maxDamage = -750, effect = CONST_ME_DRAWBLOOD},
	{name ="combat", interval = 2000, chance = 40, type = COMBAT_DEATHDAMAGE, minDamage = -800, maxDamage = -1550, radius = 2, shootEffect = CONST_ANIDEATH, target = false},
	{name ="combat", interval = 2000, chance = 25, type = COMBAT_DEATHDAMAGE, minDamage = -300, maxDamage = -850, radius = 4, effect = CONST_ME_MORTAREA, target = false},
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = -300, maxDamage = -800, range = 7, radius = 7, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true},
	{name ="speed", interval = 2000, chance = 40, speedChange = -1400, effect = CONST_ME_MAGIC_RED, target = true, duration = 20000}
}
