...
monster.description = "the goshnar's greed"
...
monster.loot = {
    ...
    {id = 34021, chance = 15000}, -- figurine of greed
    {id = 33924, chance = 8000}, -- greed's arm
	{id = 34072, chance = 2000}, -- spectral horse tack
	{id = 34073, chance = 2000}, -- spectral sadle
    {id = 34109, chance = 1000, unique = true} -- bag you desire
}

monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -1000, maxDamage = -2000},
	{name ="combat", interval = 2000, chance = 25, type = COMBAT_PHYSICALDAMAGE, minDamage = -1500, maxDamage = -2000, radius = 5, effect = CONST_ME_DEATHAREA, target = true},
	{name ="combat", interval = 4000, chance = 40, type = COMBAT_PHYSICALDAMAGE, minDamage = -1100, maxDamage = -1550, radius = 3, effect = CONST_ME_SLEEP, target = false}, 
	{name ="combat", interval = 3000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -1500, maxDamage = -2500, length = 8, spread = 0, effect = CONST_ME_POFF, target = false},
	{name ="goshnar's greed chain", interval = 5000, chance = 10, minDamage = -0, maxDamage = -0, range = 5, effect = CONST_ME_HITAREA, target = true}
}
