...
monster.description = "the goshnar's spite"
...
monster.loot = {
    ...
    {id = 33952, chance = 15000}, -- figurine of spite
    {id = 33926, chance = 8000}, -- spite's spirit
    {id = 34109, chance = 1000, unique = true} -- bag you desire
}

monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -1000, maxDamage = -2000},
	{name ="combat", interval = 2000, chance = 35, type = COMBAT_EARTHDAMAGE, minDamage = -1500, maxDamage = -2000, radius = 5, effect = CONST_ME_POISONAREA, target = true},
	{name ="combat", interval = 4000, chance = 40, type = COMBAT_EARTHDAMAGE, minDamage = -1100, maxDamage = -1550, radius = 3, effect = CONST_ME_POISONAREA, target = false}, 
	{name ="combat", interval = 3000, chance = 25, type = COMBAT_EARTHDAMAGE, minDamage = -1500, maxDamage = -2500, length = 8, spread = 0, effect = CONST_ME_POISONAREA, target = false},
	{name ="goshnar's spite chain", interval = 5000, chance = 10, minDamage = -0, maxDamage = -0, range = 5, effect = CONST_ME_POISONAREA, target = true}
}
