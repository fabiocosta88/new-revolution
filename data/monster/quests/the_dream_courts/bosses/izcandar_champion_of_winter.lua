...
monster.loot = {
	...
	{name = "winterblade", chance = 1000},
}

monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -500, maxDamage = -800},
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ICEDAMAGE, minDamage = -400, maxDamage = -650, radius = 5, effect = CONST_ME_ICEAREA, target = true},
    {name ="combat", interval = 4000, chance = 25, type = COMBAT_ICEDAMAGE, minDamage = -500, maxDamage = -700, range = 7, shootEffect = CONST_ANI_ICE, target = false},
    {name ="combat", interval = 4000, chance = 10, type = COMBAT_ICEDAMAGE, minDamage = -700, maxDamage = -1200, length = 8, spread = 0, effect = CONST_ME_GIANTICE, target = false},
    {name ="combat", interval = 2000, chance = 30, type = COMBAT_ICEDAMAGE, minDamage = -300, maxDamage = -600, length = 7, spread = 3, effect = CONST_ME_ICEATTACK, target = false}
}
...
monster.heals = {
	{type = COMBAT_ICEDAMAGE, percent = 120},
}
