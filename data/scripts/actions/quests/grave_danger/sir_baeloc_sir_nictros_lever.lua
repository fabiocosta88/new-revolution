...
function sirbaelocsirnictros.onUse(player, item, fromPosition, target, toPosition, isHotkey)
...
sirbaelocsirnictros:position({x = 33423, y = 31413, z = 13})
sirbaelocsirnictros:register()